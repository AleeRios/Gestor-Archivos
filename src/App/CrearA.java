...
public class CrearA extends javax.swing.JFrame {
    ...
    public void crearArchivo(){
        if(txtRuta.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Seleccione Ruta");
        }else{
            Path ruta=Path.of(txtRuta.getText()+"/"+txtNom.getText());
            if(!Files.exists(ruta)){
                try {
                    Files.createFile(ruta);
                    JOptionPane.showMessageDialog(null,"Archivo creado");
                } catch (IOException ex){}
            }else JOptionPane.showMessageDialog(null,"Error al crear");
        }
    }
    ...
    private void btnChooActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChooActionPerformed
        ...
        if(sel!=JFileChooser.APPROVE_OPTION){
            File f1=fc.getCurrentDirectory();
