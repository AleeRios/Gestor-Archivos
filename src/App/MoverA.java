 ...
 * @author alebe
 */
public class MoverA extends javax.swing.JFrame {

    /**
     * Creates new form MoverA
     */
    public MoverA() {
        super.setTitle("Mover y/o cortar Archivo");
        ...
        if(txtRuta.getText().equals("")){
           ...
           JOptionPane.showMessageDialog(null,"Ingresa la ruta de copia"); 
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null,"Archivo movido");
            } catch (IOException ex){JOptionPane.showMessageDialog(null,"Error al mover");}
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MoverA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
